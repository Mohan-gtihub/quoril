...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    db: {
        ...
        getCalendarEvents: (userId: string, from: string, to: string) => ipcRenderer.invoke('db:getCalendarEvents', userId, from, to),
        saveCalendarEvent: (ev: any) => ipcRenderer.invoke('db:saveCalendarEvent', ev),
        updateCalendarEvent: (id: string, updates: any) => ipcRenderer.invoke('db:updateCalendarEvent', id, updates),
        deleteCalendarEvent: (id: string) => ipcRenderer.invoke('db:deleteCalendarEvent', id),
