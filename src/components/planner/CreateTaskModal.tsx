            ...
            >
                ...
                <div className="flex flex-col gap-3 mt-8">
                    ...
                    <button
                        ...
                        className="w-full bg-emerald-500/80 hover:bg-emerald-500 text-white py-3 rounded-xl font-bold border border-emerald-400/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Create & Focus Now
                    </button>
                </div>
