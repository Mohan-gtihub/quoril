                ...
                {taskGroups.map(({ date, items }) => (
                    <div key={date} className="relative pl-6 border-l border-[var(--border-default)] space-y-4 mb-8">
                        ...
                        <div className="space-y-2">
                            {items.map((task) => (
                                <div key={task.id} className="flex items-center justify-between bg-[var(--bg-card)] border border-[var(--border-default)] p-3 rounded-xl">
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <div className="flex items-center gap-2 mt-0.5">
                                                {task.listName && (
                                                    <span
                                                        className="text-[11px] px-1.5 py-0.5 rounded-full bg-[var(--bg-tertiary)] text-[var(--text-secondary)] uppercase tracking-wider font-bold"
