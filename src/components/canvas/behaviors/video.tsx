        ...
        <div className="w-full h-full rounded-lg overflow-hidden bg-black flex flex-col border border-[var(--border-default)]">
            <div className="flex-1 min-h-0 relative">
                ...
                {active && (
                    <button
                        ...
                        className="absolute top-2 right-2 px-2 py-0.5 rounded bg-black/70 text-white text-[11px] hover:bg-black/90"
            ...
            <div className="px-2.5 py-1.5 bg-[var(--bg-card)] border-t border-[var(--border-default)] flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {meta.author && (
                        <div className="text-[11px] text-[var(--text-muted)] truncate">{meta.author}</div>
                    )}
                </div>
                <button
                    type="button"
