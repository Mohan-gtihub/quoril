        ...
        >
            <div className="flex items-center gap-2 text-[11px] uppercase tracking-wider text-[var(--text-muted)]">
                ...
                <button
                    ...
                    className="ml-auto text-[11px] underline hover:text-[var(--text-primary)]"
                >
                    change
                </button>
            </div>
            ...
            <div className="mt-auto flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                    {isRunning ? (
                        ...
                        <button
                            className="px-2 py-1 rounded-md text-xs bg-[var(--accent-primary)] text-[var(--accent-contrast)] hover:opacity-90 flex items-center gap-1"
