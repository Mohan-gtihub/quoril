    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black/40 flex items-center justify-center" onMouseDown={(e) => e.stopPropagation()}>
            <div className="w-[440px] bg-[var(--bg-card)] border border-[var(--border-default)] rounded-xl shadow-2xl p-5 space-y-4">
                ...
                <div>
                    <div className="text-[11px] uppercase tracking-wider text-[var(--text-muted)] mb-1">When</div>
                ...
                {trigMeta.needsMinutes && (
                    <div>
                        <div className="text-[11px] uppercase tracking-wider text-[var(--text-muted)] mb-1">Minimum minutes</div>
                ...
                {trigMeta.needsThreshold && (
                    <div>
                        <div className="text-[11px] uppercase tracking-wider text-[var(--text-muted)] mb-1">Threshold %</div>
                ...
                <div>
                    <div className="text-[11px] uppercase tracking-wider text-[var(--text-muted)] mb-1">Then</div>
                ...
                <div className="flex gap-2 justify-end">
                    ...
                    <button
                        ...
                        className="px-3 py-1.5 text-xs rounded bg-[var(--accent-primary)] text-[var(--accent-contrast)]"
                    >Save</button>
                </div>
            </div>
        </div>
