...
const itemCls = 'text-xs px-2 py-1.5 rounded-sm outline-none cursor-default flex items-center justify-between gap-2 text-[var(--text-primary)] data-[highlighted]:bg-[var(--accent-primary)] data-[highlighted]:text-[var(--accent-contrast)]'
const subCls = 'text-xs px-2 py-1.5 rounded-sm outline-none cursor-default flex items-center justify-between gap-2 text-[var(--text-primary)] data-[highlighted]:bg-[var(--accent-primary)] data-[highlighted]:text-[var(--accent-contrast)]'
...
function hint(text: string) {
    return <span className="text-[11px] text-[var(--text-muted)] ml-4">{text}</span>
}
