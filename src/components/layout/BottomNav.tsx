...
export function BottomNav() {
    return (
        <div className="md:hidden shrink-0 px-4 pb-4 pt-2 bg-gradient-to-t from-[var(--bg-primary)] to-transparent">
            <div className="flex items-center justify-around gap-1 bg-[var(--bg-card)] border border-[var(--border-default)] rounded-full px-2 py-1.5 shadow-[0_8px_24px_var(--glass-shadow)]">
